...
#ifndef FLOATING_POINT_OPERATION_FIX128_H
#define FLOATING_POINT_OPERATION_FIX128_H

#endif //FLOATING_POINT_OPERATION_FIX128_H
...
#define fraction_mask ((fixedptd)1 << FIXEDPOINT_FRACTION_BITS) - 1;
...
fixedptd fixedptd_exp2(fixedptd a, fixedptd not_used) {
    bool s = a < 0;
    fixedptd a_prime = abs(a);
    fixedptd b = a_prime >> FIXEDPOINT_FRACTION_BITS;
    fixedptd c = a_prime & fraction_mask;
