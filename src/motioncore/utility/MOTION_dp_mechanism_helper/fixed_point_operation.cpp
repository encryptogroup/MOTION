...
long double FixedPointToDouble(FixedPointStruct<T> fixed_point_struct) {
  long double result;
  result = (long double)(T_int(fixed_point_struct.v)) / (long double)(1 << fixed_point_struct.f);

  //    print_u128_u("T_int(fixed_point_struct.v): ", T_int(fixed_point_struct.v));
  return result;
}

template long double FixedPointToDouble<std::uint64_t, std::int64_t>(
    FixedPointStruct<std::uint64_t> fixed_point_struct);

template long double FixedPointToDouble<__uint128_t, __int128_t>(
...
template <typename T, typename T_int>
long double FixedPointToDouble(T fixed_point, std::size_t k, std::size_t f) {
  long double result;
  result = (long double)(T_int(fixed_point)) / (long double)(1 << f);
...
template long double FixedPointToDouble<std::uint64_t, std::int64_t>(std::uint64_t fixed_point,
                                                                     std::size_t k, std::size_t f);

template long double FixedPointToDouble<__uint128_t, __int128_t>(__uint128_t fixed_point,
                                                                 std::size_t k, std::size_t f);
...
template <typename T, typename T_int, typename A>
std::vector<long double> FixedPointToDouble(std::vector<T, A> fixed_point_mantissa_vector,
                                            std::size_t k, std::size_t f) {
...
FixedPointToDouble<__uint64_t, __int64_t, std::allocator<__uint64_t>>(
