...
static const fixedptd p_1045_fixedptd[] = {2147483647 , 1488522235 , 515882495 , 119194169 , 20654753 , 2863439 , 330608 , 33004 , 2632 , 309};
...
static const fixedptd p_2508_fixedptd[] = {-9846908045 , 39409229540 , -110650478746 , 240019612328 , -374029032520 , 411739189533 , -312699216715 , 156014865219 , -46057831692 , 6100571111};
static const fixedptd p_0132_fixedptd[] = {491923961 , 2793165515 , -1952752085 , 1075979665 , -260851365};
...
void generate_constants_k64_f33() {
    std::cout << "p_1045_fixedptd: ";
...
//    std::cout << "int(k): " << int(k) << std::endl;
//    std::cout << "int(k_minus_f): " << int(k_minus_f) << std::endl;
//    std::cout << "int(f_minus_k): " << int(f_minus_k) << std::endl;
...
//    std::cout << "fixeddptd_to_double(a_norm): " << fixeddptd_to_double(a_norm) << std::endl;

    fixedptd P = fixedptd_poly_eval(a_norm, p_2508_fixedptd, sizeof(p_2508_fixedptd) / sizeof(p_2508_fixedptd[0]));

//    std::cout << "fixeddptd_to_double(P): " << fixeddptd_to_double(P) << std::endl;
