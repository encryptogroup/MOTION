...
#define standard_failure_probability std::exp2l(-40)
...
std::vector<long double> decimalToFractionWithDenominatorFixed(long double x, long double denominator);
...
std::vector<double>
gaussian_distribution_box_muller(double mu, double sigma, double random_floating_point_0_1_u1, double random_floating_point_0_1_u2);
